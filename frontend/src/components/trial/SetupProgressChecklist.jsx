          ...
          <div className="relative w-12 h-12">
            <svg className="w-12 h-12 -rotate-90">
              ...
              <circle
                ...
                className={isComplete ? 'text-success' : 'text-steel-500'}
              />
            </svg>
                ...
                <Link
                  ...
                  className={`flex items-center gap-3 p-3 rounded-lg transition-all ${
                    isCompleted 
                      ...
                      : 'bg-charcoal-700/30 border border-charcoal-600 hover:border-steel-500/50 hover:bg-charcoal-700/50'
                  }`}
                  data-testid={`setup-item-${item.id}`}
                >
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 ${
                    isCompleted ? 'bg-success/20' : 'bg-charcoal-700'
                  }`}>
                    {isCompleted ? (
