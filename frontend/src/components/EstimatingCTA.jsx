...
const EstimatingCTA = () => {
  return (
    <section id="estimating" className="py-20 bg-black">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-4xl sm:text-5xl font-bold text-white mb-4" style={{ fontFamily: 'Bebas Neue, sans-serif' }}>
            Request Estimating or <span className="text-red-600">Subcontract Partnership</span>
          </h2>
          <div className="w-24 h-1 bg-red-600 mx-auto mb-6"></div>
          <p className="text-lg text-gray-400 mb-10" style={{ fontFamily: 'Open Sans, sans-serif' }}>
            For scope review, bid invitations, or subcontract pre-qualification, contact our estimating team.
          </p>
